...
bool util::isPalindrome(const std::string &text)
{
    int left = 0;
...
std::string util::replaceAll(const std::string &text, const std::string &from, const std::string &to, bool caseSensitive, bool wholeWordsOnly)
{
    ...
    std::string search = caseSensitive ? result : util::toLower(result);
    std::string pattern = caseSensitive ? from : util::toLower(from);
...
std::string util::reverse(const std::string &text)
{
    std::string result = text;
...
bool util::isWholeWord(const std::string &str, size_t pos, size_t len)
{
...
std::string util::adjustCaseCharByChar(const std::string &source, const std::string &replacement)
{
